...
const aliases_1 = require("../data/aliases");
...
const gen8bdsp = __importStar(require("../data/mods/gen8bdsp"));
const gen8legends = __importStar(require("../data/mods/gen8legends"));
...
const learn8bdsp = __importStar(require("../data/mods/gen8bdsp/learnsets"));
const learn8legends = __importStar(require("../data/mods/gen8legends/learnsets"));
...
const legality8bdsp = __importStar(require("../data/mods/gen8bdsp/legality"));
const legality8legends = __importStar(require("../data/mods/gen8legends/legality"));
...
class ModdedDex {
    ...
    loadAliases() {
        ...
        for (const [alias, target] of Object.entries(aliases_1.Aliases)) {
