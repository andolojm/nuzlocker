...
declare namespace TierTypes {
    type Singles = "AG" | "Uber" | "(AG)" | "OU" | "(OU)" | "UUBL" | "UU" | "RUBL" | "RU" | "NUBL" | "NU" | "PUBL" | "PU" | "ZUBL" | "ZU" | "NFE" | "LC";
...
interface ModdedBattlePokemon {
    ...
    formeChange?: (this: Pokemon, speciesId: string | Species, source: Effect, isPermanent?: boolean, abilitySlot?: string, message?: string) => boolean;
    ...
    queryLinkMove?: (this: Pokemon, move: ActiveMove, ignoreDisabled?: boolean) => {
        linkIndex: number;
        linkedMoves: [ActiveMove, ActiveMove];
    };
}
...
interface ModdedBattleScriptsData extends Partial<BattleScriptsData> {
    ...
    checkMoveBypassesProtect?: (this: Battle, move: ActiveMove, attacker: Pokemon, defender: Pokemon, blockStatus?: boolean) => boolean;
