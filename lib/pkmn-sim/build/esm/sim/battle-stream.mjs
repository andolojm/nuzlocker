 ...
 * @license MIT
 */
import { Streams, Utils } from '../lib/index.mjs';
import { Teams } from './teams.mjs';
import { Battle, extractChannelMessages } from './battle.mjs';
 ...
 */
export function getPlayerStreams(stream) {
    const streams = {
...
//# sourceMappingURL=battle-stream.mjs.map