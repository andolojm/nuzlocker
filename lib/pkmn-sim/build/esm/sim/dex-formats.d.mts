import { AnyObject, Battle, Effect, GameType, ID, IDEntry, ModdedBattleActions, ModdedBattlePokemon, ModdedBattleSide, ModdedBattleQueue, ModdedBattleScriptsData, ModdedDex, ModdedField, Move, Pokemon, PokemonSet, PokemonSources, Species, TeamValidator } from './exported-global-types';
...
export declare class DexFormats {
    ...
    load(): this;
    extend(formats: FormatList): this;
    private buildList;
