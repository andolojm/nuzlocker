...
export class Learnset {
    constructor(data, species) {
        ...
        if (update)
            this.eventData = Utils.deepFreeze(eventData);
    }
}
export class DexSpecies {
        ...
        if (id && this.dex.data.Pokedex.hasOwnProperty(id)) {
            ...
            if (!species.tier && !species.doublesTier && !species.natDexTier && species.baseSpecies !== species.name) {
                if (species.baseSpecies === 'Mimikyu') {
                    ...
                    species.doublesTier = this.dex.data.FormatsData[toID(species.baseSpecies)].doublesTier || species.tier;
                    ...
                    species.doublesTier = this.dex.data.FormatsData[toID(species.battleOnly)]?.doublesTier || species.tier;
    ...
    learnsetParent(species, checkingMoves = false) {
        if (['Gastrodon', 'Pumpkaboo', 'Sinistea', 'Tatsugiri'].includes(species.baseSpecies) && species.forme) {
            ...
            if (this.dex.currentMod.startsWith('champions'))
                return null;
