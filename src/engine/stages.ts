...
export const STAGES: Stage[] = withCatchStrengths([
  ...
  { type: StageType.Catch, description: "Another wild Pokémon appears nearby.", level: 3, cap: 6 },
  { type: StageType.Catch, description: "One more wild Pokémon crosses your path.", level: 5, cap: 14 },
  {
  ...
  { type: StageType.Catch, description: "A wild Pokémon rustles through the underbrush.", level: 12, cap: 20 },
  { type: StageType.Catch, description: "Another wild Pokémon catches your eye.", level: 13, cap: 20 },
  {
    type: StageType.Battle,
  ...
  { type: StageType.Catch, description: "A wild Pokémon rustles through the underbrush.", level: 18, cap: 26 },
  { type: StageType.Catch, description: "Another wild Pokémon catches your eye.", level: 20, cap: 26 },
    {
    type: StageType.Battle,
    description: "A trainer blocks the path ahead.",
  ...
  { type: StageType.Catch, description: "A wild Pokémon rustles through the underbrush.", level: 25, cap: 34 },
  { type: StageType.Catch, description: "Another wild Pokémon catches your eye.", level: 26, cap: 34 },
  {
    type: StageType.Battle,
  ...
  { type: StageType.Catch, description: "Another wild Pokémon appears nearby.", level: 32, cap: 41 },
  {
    type: StageType.Catch,
